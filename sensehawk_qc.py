...
class SensehawkQC:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('SensehawkQC', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/sensehawk_qc/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Load SenseHawk project'),
            callback=self.run,
